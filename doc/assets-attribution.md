The following is a list of assets used in the aricoin source and their proper attribution.
...
* License: MIT
* Site: [https://aricointalk.org/index.php?topic=15276.0](https://aricointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original aricoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/aricoin.icns, src/qt/res/src/aricoin.svg,
	src/qt/res/src/aricoin.ico, src/qt/res/src/aricoin.png,
	src/qt/res/src/aricoin_testnet.png, docs/aricoin_logo_doxygen.png,
