...
#ifndef H_ARICOIN_SCRIPT
#define H_ARICOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CAricoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Aricoin always counted CHECKMULTISIGs
