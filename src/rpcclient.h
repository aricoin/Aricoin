...
#ifndef _ARICOINRPC_CLIENT_H_
#define _ARICOINRPC_CLIENT_H_ 1
...
/** Show help message for aricoin-cli.
 ...
 *
 * @note the argument can be removed once aricoin-cli functionality is removed from aricoind
 */
