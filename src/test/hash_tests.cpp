...
#define T(expected, seed, data) BOOST_CHECK_EQUAL(MurmurHash3(seed, ParseHex(data)), expected)
    ...
    // but is useful for those trying to implement Aricoin libraries as a
    ...
    T(0xb074502c, 0x00000000, "00112233173006");
    T(0x8034d2a0, 0x00000000, "0011223317300677");
    T(0xb4698def, 0x00000000, "001122331730067788");
