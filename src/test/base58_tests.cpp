// Copyright (c) 2011-2014 The Aricoin Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CAricoinSecret::SetString tests isValid, whereas CAricoinAddress does not!
