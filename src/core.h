...
#ifndef ARICOIN_CORE_H
#define ARICOIN_CORE_H
...
// Aricoin aux chain ID = 0x0062 (98)
...
static const int64_t MAX_MONEY = 322649400ULL * COIN; // Aricoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000
...
public:
    ...
    {
        // Aricoin: IsDust() detection disabled, allows any valid dust to be relayed.
