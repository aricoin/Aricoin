...
public:
    ...
    AricoinAmountField *payAmount_is;
    ...
    AricoinAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new AricoinAmountField(SendCoins);
        ...
        payAmount_is = new AricoinAmountField(SendCoins_InsecurePaymentRequest);
        ...
        payAmount_s = new AricoinAmountField(SendCoins_SecurePaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to (e.g. 5St1TKAdbbBWrsxrUfcrtcXX52UrVVvCv8)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the aricoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Aricoin network.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
