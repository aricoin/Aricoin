...
#ifndef ARICOINUNITS_H
#define ARICOINUNITS_H

#include <QAbstractListModel>
#include <QString>
#include <QLocale>

/** Aricoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AricoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AricoinUnits(QObject *parent);

    /** Aricoin units.
      @note Source: https://en.aricoin.it/wiki/Units . Please add only sensible ones
     */
...
typedef AricoinUnits::Unit AricoinUnit;

#endif // ARICOINUNITS_H
