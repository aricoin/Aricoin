...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/aricoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Aricoin"),
     ...
     * override -datadir in the aricoin.conf file in the default data directory
     * (to be consistent with aricoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
