/* src/aricoin-config.h.  Generated from aricoin-config.h.in by configure.  */
/* src/aricoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ARICOIN_CONFIG_H

#define ARICOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@aricoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Aricoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Aricoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aricoin"
