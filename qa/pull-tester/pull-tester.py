#!/usr/bin/python
# Copyright (c) 2013 The Aricoin Core developers
...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old AricoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/AricoindComparisonTool_jar/AricoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/aricoin/aricoin.git")
...
environ_default("BUILD_PATH", "/mnt/aricoin")
...
environ_default("GITHUB_REPO", "aricoin/aricoin")
