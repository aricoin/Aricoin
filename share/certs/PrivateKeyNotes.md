...
unlocked to sign the Aricoin-Qt.app bundle.
...
allowing somebody to distribute a Aricoin-Qt.app or aricoin-qt-setup.exe with a valid
...
that the aricoin-qt.exe file inside the installer had not been tampered with.
